...
//
	...
	public final class KeyboardObserver {
		...
		public private(set) var currentInfo: Info?
	...
	public extension UIView {
		static func animateAlongsideKeyboard(info: KeyboardObserver.Info, animations: @escaping (() -> Void), completion: ((Bool) -> Void)? = nil) {
