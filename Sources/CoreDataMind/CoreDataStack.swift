...
public final class CoreDataStack: CoreDataTrait {
	...
	public convenience init(type: StoreType = .sqlite, modelUrl: URL? = nil, appGroupIdentifier: String? = nil, name: String = "store.sqlite", async _: Bool = false, initCompleted: CoreDataInitCompletion? = nil) {
