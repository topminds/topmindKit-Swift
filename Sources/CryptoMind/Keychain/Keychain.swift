...
public struct Keychain {
    ...
    fileprivate func createDefaultQueryWithAccount(_ account: String?) -> Query {
...
extension Keychain {
    ...
    public func secretWithoutAccessibleAttribute(account: String) throws -> String {
    ...
    public func secretWithoutAccessibleAttribute(account: String) throws -> Data {
